...
class ConnectDeviceWidget extends StatefulWidget {
  ...
  static String routeName = 'ConnectDevice';
  static String routePath = '/connectDevice';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          iconTheme: IconThemeData(color: Color(0xFF2E6385)),
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 16.0, 0.0),
                                child: Text(
                                  'To begin monitoring, please enter the wearer ID',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'The Wearer ID securely links the monitoring device to your caregiver dashboard, ensuring real-time alerts reach the right person.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
